  ...
  static async create(req, res) {
    try {
      ...
      const itemData = {
        ...
        unit: unitVal,
        current_stock: parseFloat(req.body.current_stock || req.body.stock_quantity || req.body.opening_stock || 100),
        low_stock_threshold: parseFloat(req.body.low_stock_threshold || req.body.min_stock || 10),
        track_inventory: parseInt(req.body.track_inventory !== undefined ? req.body.track_inventory : (req.body.is_trackable !== undefined ? req.body.is_trackable : 1)),
        ...
        goods_or_service: req.body.goods_or_service || req.body.item_nature || 'Goods',
        item_code: req.body.item_code || null,
        hsn_code: req.body.hsn_code || req.body.hsn || null,
        purchase_unit: req.body.purchase_unit || 'pcs',
        sales_unit: req.body.sales_unit || 'pcs',
        brand: req.body.brand || null,
        item_group: req.body.item_group || req.body.group || null,
        tags: req.body.tags || null,
        mrp: req.body.mrp !== undefined && req.body.mrp !== '' ? parseFloat(req.body.mrp) : 0.00,
        igst_rate: req.body.igst_rate !== undefined && req.body.igst_rate !== '' ? parseFloat(req.body.igst_rate) : parseFloat(req.body.gst_rate || 5),
        discount_type: req.body.discount_type || 'percentage',
        discount_value: req.body.discount_value !== undefined && req.body.discount_value !== '' ? parseFloat(req.body.discount_value) : 0.00,
        is_trackable: req.body.is_trackable !== undefined ? (req.body.is_trackable === '0' || req.body.is_trackable === 0 || req.body.is_trackable === false || req.body.is_trackable === 'false' ? 0 : 1) : 1,
        opening_stock: req.body.opening_stock !== undefined && req.body.opening_stock !== '' ? parseFloat(req.body.opening_stock) : 0.000,
        cost_price: req.body.cost_price !== undefined && req.body.cost_price !== '' ? parseFloat(req.body.cost_price) : 0.00,
        stock_start_date: req.body.stock_start_date ? String(req.body.stock_start_date).split('T')[0] : null,
        at_par_stock: req.body.at_par_stock !== undefined && req.body.at_par_stock !== '' ? parseFloat(req.body.at_par_stock) : 0.000,
        min_stock: req.body.min_stock !== undefined && req.body.min_stock !== '' ? parseFloat(req.body.min_stock) : (req.body.low_stock_threshold ? parseFloat(req.body.low_stock_threshold) : 0.000),
        linked_sales_account: req.body.linked_sales_account || 'Sales',
        linked_purchase_account: req.body.linked_purchase_account || 'Purchase',
        open_qty_popup: req.body.open_qty_popup === '1' || req.body.open_qty_popup === 1 || req.body.open_qty_popup === true || req.body.open_qty_popup === 'true' ? 1 : 0,
        open_price_popup: req.body.open_price_popup === '1' || req.body.open_price_popup === 1 || req.body.open_price_popup === true || req.body.open_price_popup === 'true' ? 1 : 0,
        not_for_sale: req.body.not_for_sale === '1' || req.body.not_for_sale === 1 || req.body.not_for_sale === true || req.body.not_for_sale === 'true' ? 1 : 0
      };
  ...
  static async update(req, res) {
    try {
      ...
      const itemData = {
        ...
        goods_or_service: req.body.goods_or_service !== undefined ? req.body.goods_or_service : existingItem.goods_or_service,
        item_code: req.body.item_code !== undefined ? req.body.item_code : existingItem.item_code,
        hsn_code: req.body.hsn_code !== undefined ? req.body.hsn_code : existingItem.hsn_code,
        purchase_unit: req.body.purchase_unit !== undefined ? req.body.purchase_unit : existingItem.purchase_unit,
        sales_unit: req.body.sales_unit !== undefined ? req.body.sales_unit : existingItem.sales_unit,
        brand: req.body.brand !== undefined ? req.body.brand : existingItem.brand,
        item_group: req.body.item_group !== undefined ? req.body.item_group : existingItem.item_group,
        tags: req.body.tags !== undefined ? req.body.tags : existingItem.tags,
        mrp: req.body.mrp !== undefined ? parseFloat(req.body.mrp) : existingItem.mrp,
        igst_rate: req.body.igst_rate !== undefined ? parseFloat(req.body.igst_rate) : existingItem.igst_rate,
        discount_type: req.body.discount_type !== undefined ? req.body.discount_type : existingItem.discount_type,
        discount_value: req.body.discount_value !== undefined ? parseFloat(req.body.discount_value) : existingItem.discount_value,
        is_trackable: req.body.is_trackable !== undefined ? (req.body.is_trackable === '0' || req.body.is_trackable === 0 || req.body.is_trackable === false || req.body.is_trackable === 'false' ? 0 : 1) : existingItem.is_trackable,
        opening_stock: req.body.opening_stock !== undefined ? parseFloat(req.body.opening_stock) : existingItem.opening_stock,
        cost_price: req.body.cost_price !== undefined ? parseFloat(req.body.cost_price) : existingItem.cost_price,
        stock_start_date: req.body.stock_start_date !== undefined ? (req.body.stock_start_date ? String(req.body.stock_start_date).split('T')[0] : null) : (existingItem.stock_start_date ? String(existingItem.stock_start_date).split('T')[0] : null),
        at_par_stock: req.body.at_par_stock !== undefined ? parseFloat(req.body.at_par_stock) : existingItem.at_par_stock,
        min_stock: req.body.min_stock !== undefined ? parseFloat(req.body.min_stock) : existingItem.min_stock,
        linked_sales_account: req.body.linked_sales_account !== undefined ? req.body.linked_sales_account : existingItem.linked_sales_account,
        linked_purchase_account: req.body.linked_purchase_account !== undefined ? req.body.linked_purchase_account : existingItem.linked_purchase_account,
        open_qty_popup: req.body.open_qty_popup !== undefined ? (req.body.open_qty_popup === '1' || req.body.open_qty_popup === 1 || req.body.open_qty_popup === true || req.body.open_qty_popup === 'true' ? 1 : 0) : existingItem.open_qty_popup,
        open_price_popup: req.body.open_price_popup !== undefined ? (req.body.open_price_popup === '1' || req.body.open_price_popup === 1 || req.body.open_price_popup === true || req.body.open_price_popup === 'true' ? 1 : 0) : existingItem.open_price_popup,
        not_for_sale: req.body.not_for_sale !== undefined ? (req.body.not_for_sale === '1' || req.body.not_for_sale === 1 || req.body.not_for_sale === true || req.body.not_for_sale === 'true' ? 1 : 0) : existingItem.not_for_sale
      };
